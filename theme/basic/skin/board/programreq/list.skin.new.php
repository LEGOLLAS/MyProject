...
*/ ?>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <?php if ($member['mb_level'] >= $board['bo_read_level']) { ?>
                <a href="<?php echo $list[$i]['href'] ?>&isNew=Y">
            ...
            if ($list[$i]['wr_2'] <= date('Ymd') && $list[$i]['wr_3'] >= date('Ymd') && $list[$i]['req'] < 1 && $member['mb_level'] < 5) { 
				//echo "select count(*) cnt from program_req where program_id='".$list[$i]['wr_id']."' AND status='D'";
    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>&isNew=Y" class="btn_b01">목록</a></li><?php } ?>
