...
*/ ?>
    ...
    <div id="bo_v_bot">
        ...
        <ul class="bo_v_com">
            ...
            <li><a href="<?php echo './programreq.php?bo_table='.$bo_table.'&amp;page='.$page ?>" class="btn_b01">목록</a></li>
...
<div style="border-top: 1px solid #e5e5e5;border-bottom: 1px solid #e5e5e5;margin-bottom: 5px;padding: 10px;">
    <form method="get" action="/bbs/board.php">
        ...
        <div style="text-align:center;margin-top: 5px;padding-top: 5px;">
            ...
            <a href="/bbs/board.php?bo_table=programreq&wr_id=<?php echo $view['wr_id']; ?>" class="btn_b03">초기화</a>
        </div>
    </form>
</div>
