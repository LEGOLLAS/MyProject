...
function FlashActiveX (file,width,height) {
...
// Flash Player 8.0.0.0
function FlashActiveX_main (file,width,height) {
	document.write("<object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0' width='" + width + "' height='" + height + "' id='mainflash' align='middle'>");
	document.write("<param name='allowScriptAccess' value='sameDomain' />");
	document.write("<param name='allowFullScreen' value='false' />");
	document.write("<param name='movie' value='" +file + "' />");
	document.write("<param name='quality' value='high' />");
	document.write("<param name='wmode' value='transparent' />");
	document.write("<embed src='" +file + "' quality='high' wmode='transparent' width='" + width + "' height='" + height + "' name='mainflash' align='middle' allowScriptAccess='sameDomain' allowFullScreen='false' type='application/x-shockwave-flash' pluginspage='http://www.macromedia.com/go/getflashplayer' />");
...
function showMediaView(source, width, height) {
	document.write("<embed src='" +source + "' quality='high' wmode='transparent' ");
	document.write(" width='" + width + "' height='" + height + "' ");
	document.write(" loop='true' AutoStart='true' ShowControls='0' showstatusbar='0' name='mainflash'  ");
	document.write(" />");
}
