...
<script>
	...
	<div id="contentArea">
		<div id="subTitle">프로그램 카테고리 관리 [엑셀 업로드 - 일괄삭제]</div>
		<div id="subContent">
			<div style="padding:10px 10px 10px 10px;">
				...
				<div style="padding-top:30px; font-size:15px;">
					...
					<div style="font-size:13px; padding-left:10px; line-height:160%;">
						- <span style="color:red;">단, 엑셀파일 업로드해주시기 전에 "<span style="font-weight:bold;">엑셀-데이터 다운로드 Click</span>"를 클릭 후, 다운로드 받으신 엑셀파일을 열어보셔서 전체 데이터를 확인해보시고, 삭제해주실 "프로그램 카테고리 고유번호"들만 다운로드 받으신 엑셀 파일에 남겨주시고, 나머지 "프로그램 카테고리 고유번호"는 다운로드 받으신 엑셀 파일에서만 삭제를 하시고, 저장하신 다음에 업로드해주세요.</span>
					</div>
				</div>
