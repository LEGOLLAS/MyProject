...
<script>
	function insertFormSubmit() {
		...
		if(insertForm.program_category_id.value == "") {
			alert("프로그램 분류를 선택해주세요.");
			insertForm.program_category_id.focus();
			return false;
		}
		
		if(insertForm.program_manage_id.value == "") {
			alert("프로그램 운영일을 선택해주세요.");
			insertForm.program_manage_id.focus();
			return false;
		}
			...
			<div class="contentArea">
				...
				<div id="insertArea">					
					...
					<tr height="40px" align="center">
						...
						<td align="left">
							<input type="text" name="wr_subject" id="wr_subject" style="width:98%; height:30px;" />
						</td>
					</tr>
					<tr height="40px" align="center">
						<th width="15%" bgcolor="#EFEFEF">대상</th>
						<td align="left">
							<input type="text" name="wr_1" id="wr_1" style="width:98%; height:30px;" />
						</td>
					</tr>
					<tr height="40px" align="center">
						<th width="15%" bgcolor="#EFEFEF">정원</th>
						<td align="left">
							<input type="text" name="wr_6" id="wr_6" style="width:98%; height:30px;" />
						</td>
					</tr>
					<tr height="40px" align="center">
					...
					<tr height="40px" align="center">
						...
						<td align="left">
							<input type="text" name="wr_4" id="wr_4" style="width:98%; height:30px;" />
						</td>
					</tr>
					<tr height="40px" align="center">
						...
						<td class="wr_content">
							...
							<textarea id="wr_content" name="wr_content" class="smarteditor2" maxlength="65536" style="width:100%;height:300px"><?=$row['wr_content']?></textarea>
						</td>
					</tr>
					<tr height="40px" align="center">
						<th width="15%" bgcolor="#EFEFEF">비고</th>
						<td align="left">
							<textarea name="wr_5" id="wr_5" style="width:98%; height:150px;" /></textarea>
						</td>
					</tr>
					<tr height="40px" align="center">
					...
					<tr height="40px" align="center">
						...
						<td align="left">
							<input type="text" name="program_sort" id="program_sort" style="width:98%; height:30px;" />
						</td>
					</tr>
					</table>
				</div>
