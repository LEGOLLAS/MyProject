...
if ($w == '') {
    $sql = " insert into {$g5['member_table']}
                set mb_id = '{$mb_id}',
                     ...
                     is_mb_children = '{$is_mb_children}',
                     mb_children_re_cnt = '{$mb_children_re_cnt}',
                     mb_1 = '{$mb_1}',
                     mb_2 = '{$mb_2}',
                     mb_3 = '{$mb_3}',
                     mb_4 = '{$mb_4}',
	...
	// 자녀 정보 입력 추가 - 2017.12.21(목) - (주)네오인터넷 함민석 대리
	$mb_children_count = count($_POST['mb_children_name']);
	
	for($j=0; $j<$mb_children_count; $j++) {
		$mb_children_name = $_POST['mb_children_name'][$j];
		$mb_children_birth = $_POST['mb_children_birth'][$j];
		$mb_children_sex = $_POST['mb_children_sex'][$j];
		
		$mb_children_sql = " insert into g5_member_children
                set mb_id = '{$mb_id}',
                     mb_children_name = '{$mb_children_name}',
                     mb_children_birth = '{$mb_children_birth}',
                     mb_children_sex = '{$mb_children_sex}'";
		
		sql_query($mb_children_sql);
	}
	...
	$mb_children_delete_sql = "delete from g5_member_children where mb_id = '{$mb_id}'";
	sql_query($mb_children_delete_sql);
