...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col" id="mb_list_mobile">자녀정보</th>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="mb_list_email" class="td_email"><?php echo get_text($row['mb_email']); ?></td>
        <td headers="mb_list_mobile" class="td_tel"><?php echo get_text($row['mb_hp']); ?></td>
        <td headers="mb_list_mb_5" class="td_tel"><?php echo get_text($row['mb_5']); ?></td>
        <td headers="mb_list_mb_5" class="td_tel" style="text-align:left !important;">
			<div>자녀여부 : <?=$row['is_mb_children']?></div>
			<div>자녀수 : <?=$row['mb_children_re_cnt']?>명</div>
			<div><a href="./member_children_list.php?mb_id=<?=$row['mb_id']?>">[ 자녀목록으로 ]</a></div>
		</td>
