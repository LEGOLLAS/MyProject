...
if(!sql_query(" DESCRIBE {$g5['menu_table']} ", false)) {
    sql_query(" CREATE TABLE IF NOT EXISTS `{$g5['menu_table']}` (
                  ...
                  `me_last_code` varchar(255) NULL DEFAULT '',
                  `m_code` varchar(255) NOT NULL DEFAULT '',
                  `me_name` varchar(255) NOT NULL DEFAULT '',
                  `me_link` varchar(255) NOT NULL DEFAULT '',
                  `me_target` varchar(255) NOT NULL DEFAULT '0',
                  `me_sub_img` varchar(255) NULL DEFAULT '',
...
<div id="menulist" class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col">링크</th>
        <th scope="col">코드</th>
        <th scope="col"><div>최종</div><div>코드</div></th>
        <th scope="col">새창</th>
        <th scope="col">순서</th>
        <th scope="col"><div>서브</div><div>이미지번호</div></th>
    ...
    <tr class="<?php echo $bg; ?> menu_list menu_group_<?php echo substr($row['me_code'], 0, 2); ?>">
        ...
        <td class="td_mng">
            <label for="m_code_<?php echo $i; ?>" class="sound_only">코드</label>
            <input type="text" name="m_code[]" value="<?php echo $row['m_code'] ?>" id="m_code_<?php echo $i; ?>" class="frm_input" size="10">
        </td>
        <td class="td_mng">
            <label for="m_code_<?php echo $i; ?>" class="sound_only">최종코드</label>
            <input type="text" name="me_last_code[]" value="<?php echo $row['me_last_code'] ?>" id="m_code_<?php echo $i; ?>" class="frm_input" size="10">
        </td>
        <td class="td_mng">
        ...
        <td class="td_num">
            <label for="me_sub_img_<?php echo $i; ?>" class="sound_only">서브이미지번호</label>
            <input type="text" name="me_sub_img[]" value="<?php echo $row['me_sub_img'] ?>" id="me_sub_img_<?php echo $i; ?>" class="frm_input" size="5" style="text-align:center;" />
        </td>
        <td class="td_mng">
