...
if(!sql_query(" DESCRIBE `g5_menu_new` ", false)) {
    sql_query(" CREATE TABLE IF NOT EXISTS `g5_menu_new` (
...
$sql = " select * from `g5_menu_new` order by me_id ";
...
<form name="fmenulist" id="fmenulist" method="post" action="./menu_list_update_new.php" onsubmit="return fmenulist_submit(this);">
...
function add_menu()
{
    ...
    var url = "./menu_form_new.php?code="+max_code+"&new=new";
...
{
    var url = "./menu_form_new.php?code="+code;
    window.open(url, "add_menu", "left=100,top=100,width=550,height=650,scrollbars=yes,resizable=yes");
    return false;
}
