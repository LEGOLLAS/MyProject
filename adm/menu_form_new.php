...
function add_menu_list(name, link, code)
{
    ...
    list += "<label for=\"m_code_"+ms+"\" class=\"sound_only\">코드</label>";
    list += "<input type=\"text\" name=\"m_code[]\" value=\"\" id=\"m_code_"+ms+"\" class=\"frm_input\" size=\"10\">";
    list += "</td>";
