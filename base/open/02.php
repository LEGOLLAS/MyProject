...
<caption></caption>
  <tr>
    <td width="11%" height="29" valign="top"><a href="/base/open/02.php"><img src="/base/images/open_tab02_01_ov.gif" alt="사진" border="0" title="사진" /></a></td>
    <td width="89%" valign="top"><a href="/base/open/02_01.php"><img src="/base/images/open_tab02_02_out.gif" alt="동영상" border="0" title="동영상"/></a></td>
  </tr>
</table><br />

            <div id="contView">
<a href="http://jile.jejunu.ac.kr:10780/board/bbs/board.php?bo_table=album&page=1&style=webzine" target="viewFrame"><img src="/images/b_board.gif" alt="이전게시판가기" title="이전게시판가기" /></a>
<br>
<?
//$bo_table = "contents_base";
//$wr_id = "";

$bo_table = "base_open_02";
$sca = "기초교양교육원"; // 기초교육원
$wr_id = $_GET[wr_id];
